...
(5am:test subtypep.member.19
  (let ((i1 (1+ most-positive-fixnum))
        (i2 (1+ most-positive-fixnum)))
    (check-equivalence `(member 0 ,i1) `(member 0 ,i2)))
  nil)

(5am:test subtypep.member.20
  (check-equivalence '(and (member a b c d) (member e d b f g))
                     '(member b d))
  nil)

(5am:test subtypep.member.21
  (check-equivalence '(and (member a b c d) (member e d f g))
                     '(eql d))
  nil)

(5am:test subtypep.member.22
  (check-equivalence '(and (member a b c d) (member e f g))
                     nil)
  nil)

(5am:test subtypep.member.23
  (check-equivalence '(or (member a b c) (member z b w))
                     '(member z a b w c))
  nil)

(5am:test subtypep.member.24
  (check-equivalence '(or (member a b c) (eql d))
                     '(member d c b a))
  nil)

(5am:test subtypep.member.25
  (check-equivalence 'boolean '(member nil t))
  nil)

(5am:test subtypep.member.26
  (check-equivalence '(or (eql a) (eql b))
                     '(member a b))
  nil)

(5am:test subtypep.member.27
  (check-all-subtypep '(member a b c d) '(satisfies symbolp))
  nil)

(5am:test subtypep.member.28
  (check-all-subtypep '(member a b c d) t)
  nil)

(5am:test subtypep.member.29
  (check-all-not-subtypep '(member a b 10 z) '(satisfies symbolp) nil)
  nil)

(5am:test subtypep.member.30
  (check-disjointness '(member 1 6 10) '(satisfies symbolp) nil)
  nil)

(5am:test subtypep.member.31
  (check-equivalence '(member a b c d) '(member c d b a))
  nil)

(5am:test subtypep.member.32
  (check-all-not-subtypep '(not (member a b 10 z)) '(satisfies symbolp) nil)
  nil)

(5am:test subtypep.member.33
  (check-all-not-subtypep  '(satisfies symbolp) '(member a b 10 z) nil)
  nil)

(5am:test subtypep.member.34
  (check-all-not-subtypep '(member a b 10 z) '(not (satisfies symbolp)) nil)
  nil)

(5am:test subtypep.member.35
  (check-all-not-subtypep  '(satisfies symbolp) '(member a b c d) nil)
  nil)

(5am:test subtypep.member.36
  (check-disjointness '(eql a) '(or (member b c d) (eql e)))
  nil)

(5am:test subtypep.member.37
  (check-equivalence
   '(and (member a b c d) (not (eql c)))
   '(member a b d))
  nil)

(5am:test subtypep.member.38
  (check-equivalence
