...
(5am:def-suite subtypep.cons :in subtypep)
(5am:in-suite subtypep.cons)
...
;;; notnot-mv of subtypep in original ansi
(deftest subtypep.cons.35
    (subtypep* '(cons nil t) 'float)
  t t)

(deftest subtypep.cons.36
    (subtypep* '(cons t nil) 'symbol)
  t t)

(deftest subtypep.cons.37
    (subtypep* '(cons nil nil) 'real)
  t t)
