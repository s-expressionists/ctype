...
(5am:def-suite subtypep.real :in subtypep)
(5am:in-suite subtypep.real)

;;; SUBTYPEP on real types

(5am:test subtypep.real.1
...
(5am:test subtypep.real.5
  (check-equivalence
   '(or (real 0 0) (real (0)))
   '(real 0))
  nil)

(5am:test subtypep.real.6
  (check-equivalence
   '(and (real 0 10) (real 5 15))
   '(real 5 10))
  nil)

(5am:test subtypep.real.7
  (check-equivalence
   '(and (real (0) 10) (real 5 15))
   '(real 5 10))
  nil)

(5am:test subtypep.real.8
  (check-equivalence
   '(and (real 0 (10)) (real 5 15))
   '(real 5 (10)))
  nil)

(5am:test subtypep.real.9
  (check-equivalence
   '(and (real (0) (10)) (real 5 15))
   '(real 5 (10)))
  nil)

(5am:test subtypep.real.10
  (check-equivalence
   '(and (real 0 10) (real (5) 15))
   '(real (5) 10))
  nil)

(5am:test subtypep.real.11
  (check-equivalence
   '(and (real 0 (10)) (real (5) 15))
   '(real (5) (10)))
  nil)

(5am:test subtypep.real.12
  (check-equivalence
   '(and integer (real 0 10) (not (real (0) (10))))
   '(member 0 10))
  nil)

(5am:test subtypep.real.13
  (check-equivalence '(and integer (real -1/2 1/2))
                     '(integer 0 0))
  nil)

(5am:test subtypep.real.14
  (check-equivalence '(and integer (real -1/2 1/2))
                     '(eql 0))
  nil)

(5am:test subtypep.real.15
  (check-equivalence '(and integer (real (-1/2) 1/2))
                     '(integer 0 0))
  nil)

(5am:test subtypep.real.16
  (check-equivalence '(and integer (real (-1/2) (1/2)))
                     '(integer 0 0))
  nil)

(5am:test subtypep.real.17
  (check-equivalence '(real 0 10) '(real 0.0 10.0))
  nil)

(5am:test subtypep.real.18
  (check-equivalence '(and rational (real 0 10))
                     '(rational 0 10))
  nil)

(5am:test subtypep.real.19
  (check-equivalence '(and rational (real 0 (10)))
                     '(rational 0 (10)))
  nil)

(5am:test subtypep.real.20
  (check-equivalence '(and rational (real (0) (10)))
                     '(rational (0) (10)))
  nil)

(5am:test subtypep.real.21
  (check-equivalence '(and rational (real 1/2 7/3))
                     '(rational 1/2 7/3))
  nil)

(5am:test subtypep.real.22
  (check-equivalence '(and rational (real (1/11) (8/37)))
                     '(rational (1/11) (8/37)))
  nil)

(5am:test subtypep.real.23
  (check-all-subtypep '(not (real -1/2 1/2)) '(not (integer 0 0)))
  nil)

(5am:test subtypep.real.24
  (check-all-subtypep '(not (real -1/2 1/2)) '(not (eql 0)))
  nil)

(5am:test subtypep.real.25
