...
(defexclusives cproperty-list
  cclass range ccomplex carray charset cfunction fpzero)

(defmethod subctypep (client (ct1 cproperty-list) (ct2 csequence))
  (declare (ignore client))
  (values t t))
(defmethod subctypep (client (ct1 csequence) (ct2 cproperty-list))
  (declare (ignore client))
  (values nil t))
(define-commutative-method disjointp (client (ct1 cproperty-list) (ct2 csequence))
  (declare (ignore client))
  (values nil t))
(define-commutative-method conjoin/2 (client (ct1 cproperty-list) (ct2 csequence))
  (declare (ignore client))
  ct1)
(define-commutative-method disjoin/2 (client (ct1 cproperty-list) (ct2 csequence))
  (declare (ignore client))
  ct2)
(defmethod subtract (client (ct1 cproperty-list) (ct2 csequence))
  (declare (ignore client))
  (bot))
