...
(define-commutative-method disjointp (list-of list-of) (ccons ccons)
  (or/tri (disjointp (ccons-car ccons) (element-ctype list-of))
          (disjointp (ccons-cdr ccons) list-of)))

(define-commutative-method disjointp (list-of list-of) (cmember cmember)
  (values (not (member nil (cmember-members cmember))) t))

(defexclusives list-of range ccomplex carray charset cfunction fpzero)

(define-commutative-method conjointp (ct1 list-of) (ct2 cclass)
  (values nil t))
...
(define-commutative-method disjointp (ct1 list-of) (ct2 cclass)
  (values (not (sequence-cclass-p ct2)) t))
(define-commutative-method conjoin/2 (ct1 list-of) (ct2 cclass)
  (if (sequence-cclass-p ct2) ct1 (bot)))
(define-commutative-method disjoin/2 (ct1 list-of) (ct2 cclass)
