...
(defmethod disjointp (client (ct1 cclass) (ct2 cclass))
  ;; Classes aren't disjoint to themselves, or to subclasses.
  (cond
    ((subclassp client (cclass-class ct1) (cclass-class ct2))
     (values nil t))
    ((subclassp client (cclass-class ct2) (cclass-class ct1))
     (values nil t))
    (t ;; Pick off cases defined by 4.2.2.
